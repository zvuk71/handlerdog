...
;(function ($) {
  ...
  $.HSCore.components.HSSummernoteEditor = {
    ...
    */
    _baseConfig: {
      height: 100,
      placeholder: 'Для додання фото і відео до своєї сторінки - тисніть кнопки Picture і Video. Бажаний розмір фото - 1920x1080 (формат 16:9). Додання посилань на ролики Youtube  у спливаюче вікно - через кому.'},
